// Tic-tac-Toe AI to find the next optimal move using minimax algorithm
...
export function findBestMove(board)
{
    ...
    if(firstMove) {
        ...
        if (board[i][j] !== '_') {
            return findBestMove(board); //try again
        } else {
            firstMove = false;
            bestMove.row = i;
            bestMove.col = j;
    ...
    console.log("The best move is: " + JSON.stringify(bestMove));
